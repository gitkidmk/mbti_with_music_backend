...
set JARPATH=%APP_HOME%\lib\mbti_with_music_backend-0.0.1-SNAPSHOT.jar

@rem Execute mbti_with_music_backend
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MBTI_WITH_MUSIC_BACKEND_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
